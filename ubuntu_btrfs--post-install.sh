...
rm -rv /mnt/@/var/cache/* || echo "No cache directory"    # Copy the cache directory to the cache subvolume
sudo cp -av /mnt/@/var/log/* /mnt/@log
rm -rv /mnt/@/var/log/* || echo "No log directory"    # Copy the log directory to the log subvolume
